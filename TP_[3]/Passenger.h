 ...
 * @return
 */
int Passenger_setId(Passenger* this,int id);//[HECHA]
 ...
 * @return
 */
int Passenger_getId(Passenger* this,int* id);//[HECHA]
 ...
 * @return
 */
int Passenger_setNombre(Passenger* this,char* nombre);//[HECHA]
 ...
 * @return
 */
int Passenger_getNombre(Passenger* this,char* nombre);//[HECHA]
 ...
 * @return
 */
int Passenger_setApellido(Passenger* this,char* apellido);//[HECHA] - [MY ADDITION]
 ...
 * @return
 */
int Passenger_getApellido(Passenger* this,char* apellido);//[HECHA] - [MY ADDITION]
 ...
 * @return
 */
int Passenger_setCodigoVuelo(Passenger* this,char* codigoVuelo);//[HECHA]
 ...
 * @return
 */
int Passenger_getCodigoVuelo(Passenger* this,char* codigoVuelo);//[HECHA]
 ...
 * @return
 */
int Passenger_setTipoPasajero(Passenger* this,int tipoPasajero);//[HECHA]
 ...
 * @return
 */
int Passenger_getTipoPasajero(Passenger* this,int* tipoPasajero);//[HECHA]
 ...
 * @return
 */
int Passenger_setPrecio(Passenger* this,float precio);//[HECHA]
 ...
 * @return
 */
int Passenger_getPrecio(Passenger* this,float* precio);//[HECHA]
 ...
 * @return
 */
int Passenger_setStatusFlight(Passenger* this,int statusFlight);//[HECHA] - [MY ADDITION]
 ...
 * @return
 */
int Passenger_getStatusFlight(Passenger* this,int* statusFlight);//[HECHA] - [MY ADDITION]
 ...
 */
int Passenger_getAll(Passenger* this,char* name,char* lastname,float* price,char* flightCode,int* type,int* status,int* id);//[HECHA] - [MY ADDITION]
