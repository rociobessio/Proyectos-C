...
/** \brief Devuelve el elemento en la lista en el indice especificado
 *
 * \param this LinkedList* Puntero a la lista
 ...
 * @return linkedList* nuevo con los elementos que pasaron la funcion
 */
LinkedList* ll_filter(LinkedList* this, int (*pFunc)(void*));

LinkedList* ll_map(LinkedList* this, float (*pFunc)(void* element));
